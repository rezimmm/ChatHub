...
import { MessageSquare, Plus, Hash, LogOut, Users, Star, Settings, Lock, Wifi, WifiOff, Loader2, Sun, Moon } from 'lucide-react';
import { Avatar, AvatarImage, AvatarFallback } from './ui/avatar';

export default function Sidebar({ channels, currentChannel, onSelectChannel, onCreateChannel, onToggleFavorite, user, onLogout, onOpenProfile, onOpenUserList, wsStatus, darkMode, setDarkMode }) {
