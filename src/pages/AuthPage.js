...
export default function AuthPage({ onLogin }) {
  ...
  return (
    <div 
      className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-violet-50 via-white to-teal-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900"
      style={{
